...
ICONS = {
    ...
    "results": ("""<!-- Icon from Unicons by Iconscout - https://github.com/Iconscout/unicons/blob/master/LICENSE --><path fill="currentColor" d="M20.07 6.11a9.85 9.85 0 0 0-4.3-3.36A10 10 0 0 0 2 12v.56A9.94 9.94 0 0 0 3.33 17a10 10 0 0 0 5.89 4.65A10 10 0 0 0 12 22a9.5 9.5 0 0 0 1.88-.18a10 10 0 0 0 8-8.41A9.5 9.5 0 0 0 22 12a9.83 9.83 0 0 0-1.93-5.89m-2 .77L17 9.74l-1.62.44L13 8.49V6.64l2.49-1.81a7.8 7.8 0 0 1 2.62 2.05ZM14 11.67L13.22 14h-2.45L10 11.67l2-1.43ZM12 4a8 8 0 0 1 1.11.09l-1.11.8l-1.11-.8A8 8 0 0 1 12 4M4.88 8.37l.4 1.32l-1.13.79a7.9 7.9 0 0 1 .73-2.11m1.37 9.17l1.38.05l.37 1.33a8.3 8.3 0 0 1-1.75-1.38M8 15.6l-3.15-.11A7.8 7.8 0 0 1 4.07 13l2.49-1.74l1.44.62l.89 2.76Zm.86-5.53l-1.56-.7l-.91-3A8 8 0 0 1 8.5 4.83L11 6.64v1.85ZM13 19.93a8.1 8.1 0 0 1-2.63-.12l-.83-2.92l.83-.89h3.07l.67 1Zm2.41-.7l.46-1.23l1.36.07a7.8 7.8 0 0 1-1.85 1.16Zm3.46-3.12L15.76 16l-.71-1.1l.89-2.76l1.51-.41l2.36 2a7.8 7.8 0 0 1-.97 2.38Zm.05-5.83L19.4 9a7.4 7.4 0 0 1 .53 2.13Z"/>"""),
    "position": ("""<!-- Icon from Unicons by Iconscout - https://github.com/Iconscout/unicons/blob/master/LICENSE --><path fill="currentColor" d="M21 4h-3V3a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1v1H3a1 1 0 0 0-1 1v3a4 4 0 0 0 4 4h1.54A6 6 0 0 0 11 13.91V16h-1a3 3 0 0 0-3 3v2a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-2a3 3 0 0 0-3-3h-1v-2.09A6 6 0 0 0 16.46 12H18a4 4 0 0 0 4-4V5a1 1 0 0 0-1-1M6 10a2 2 0 0 1-2-2V6h2v2a6 6 0 0 0 .35 2Zm8 8a1 1 0 0 1 1 1v1H9v-1a1 1 0 0 1 1-1Zm2-10a4 4 0 0 1-8 0V4h8Zm4 0a2 2 0 0 1-2 2h-.35A6 6 0 0 0 18 8V6h2Z"/>"""),
    "form": ("""<!-- Icon from Unicons by Iconscout - https://github.com/Iconscout/unicons/blob/master/LICENSE --><path fill="currentColor" d="M7 16a1.5 1.5 0 0 0 1.5-1.5a1 1 0 0 0 0-.15l2.79-2.79h.46l1.61 1.61v.08a1.5 1.5 0 1 0 3 0v-.08L20 9.5A1.5 1.5 0 1 0 18.5 8a1 1 0 0 0 0 .15l-3.61 3.61h-.16L13 10a1.49 1.49 0 0 0-3 0l-3 3a1.5 1.5 0 0 0 0 3m13.5 4h-17V3a1 1 0 0 0-2 0v18a1 1 0 0 0 1 1h18a1 1 0 0 0 0-2"/>"""),
}
